...
{
  assert(PLANNER_VERSION === '49.9' || PLANNER_VERSION === '49.8' || PLANNER_VERSION === '49.7' || PLANNER_VERSION === '49.6' || PLANNER_VERSION === '49.5' || PLANNER_VERSION === '49.4' || PLANNER_VERSION === '49.3', 'PLANNER_VERSION current');
  assert(/49.(3|4|5|6|7|8|9)/.test(PLANNER_BUILD), 'PLANNER_BUILD');
  assert(/const VERSION = '49\.[3456789]'/.test(appSrc), 'frontend VERSION');
  assert(/carmen-build" content="49\.[3456789]"/.test(html), 'html build');
...
console.log('--- v49.3 /api docs + health ---');
{
  ...
  assert((h.version === '49.9' || h.version === '49.8' || h.version === '49.7' || h.version === '49.6' || h.version === '49.5' || h.version === '49.4' || h.version === '49.3') && /49.(3|4|5|6|7|8|9)/.test(h.build || ''), 'health current');
