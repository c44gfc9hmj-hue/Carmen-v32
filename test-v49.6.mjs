...
{
  assert(PLANNER_VERSION === '49.8' || PLANNER_VERSION === '49.7' || PLANNER_VERSION === '49.6', 'PLANNER_VERSION current');
  assert(PLANNER_BUILD === '49.8-adaptive-investigation' || PLANNER_BUILD === '49.7-retrieval-engine' || PLANNER_BUILD === '49.6-correctness-ux', 'PLANNER_BUILD');
  assert(/const VERSION = '49\.[678]'/.test(appSrc), 'frontend VERSION');
  assert(/carmen-build" content="49\.[678]"/.test(html), 'html build');
  assert(/v49\.[678]/.test(html), 'header shows version');
