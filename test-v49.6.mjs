...
{
  assert(PLANNER_VERSION === '49.13' || PLANNER_VERSION === '49.12' || PLANNER_VERSION === '49.11' || PLANNER_VERSION === '49.9' || PLANNER_VERSION === '49.8' || PLANNER_VERSION === '49.7' || PLANNER_VERSION === '49.6', 'PLANNER_VERSION current');
  assert(PLANNER_BUILD === '49.13-investigation-actions' || PLANNER_BUILD === '49.12-investigation-workflow' || PLANNER_BUILD === '49.11-exact-source-retrieval' || PLANNER_BUILD === '49.9-identity-queue-visual' || PLANNER_BUILD === '49.8-adaptive-investigation' || PLANNER_BUILD === '49.7-retrieval-engine' || PLANNER_BUILD === '49.6-correctness-ux', 'PLANNER_BUILD');
  assert(/const VERSION = '49\.(?:[6-9]|11|12|13)'/.test(appSrc), 'frontend VERSION');
  assert(/carmen-build" content="49\.(?:[6-9]|11|12|13)"/.test(html), 'html build');
  assert(/v49\.(6|7|8|9|11|12|13)/.test(html), 'header shows version');
