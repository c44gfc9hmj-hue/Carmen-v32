...
{ const { status, body } = await call('/health');
  ...
  assert(body.version === '49.9' || body.version === '49.8' || body.version === '49.7' || body.version === '49.6' || body.version === '49.5' || body.version === '49.4' || body.version === '49.3', 'version current');
  ...
  assert(body.build === '49.9-identity-queue-visual' || body.build === '49.8-adaptive-investigation' || body.build === '49.7-retrieval-engine' || body.build === '49.6-correctness-ux' || body.build === '49.5-adult-first-nl' || body.build === '49.4-deep-dive-lenses' || body.build === '49.3-chatgpt-access', 'build current');
