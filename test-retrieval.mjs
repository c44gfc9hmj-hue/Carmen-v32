...
{ const { status, body } = await call('/health');
  ...
  assert(body.version === '50' || body.version === '49.14' || body.version === '49.13' || body.version === '49.12' || body.version === '49.11' || body.version === '49.9' || body.version === '49.8' || body.version === '49.7' || body.version === '49.6' || body.version === '49.5' || body.version === '49.4' || body.version === '49.3', 'version current');
  ...
  assert(body.features.includes('adult-lens'), 'features include adult-lens');
  assert(body.features.includes('investigation-choices'), 'features include investigation-choices');
  ...
  assert(body.features.includes('intersection-first'), 'features include intersection-first');
  assert(body.features.includes('analysis-retry'), 'features include analysis-retry');
  assert(body.features.includes('bounded-analysis'), 'features include bounded-analysis');
  assert(body.features.includes('continue-batch'), 'features include continue-batch');
  assert(body.features.includes('source-restriction'), 'features include source-restriction');
  assert(body.features.includes('visual-corpus'), 'features include visual-corpus');
  assert(body.features.includes('investigate-further'), 'features include investigate-further');
  assert(body.features.includes('clothing'), 'features include clothing');
  assert(body.features.includes('premium-content'), 'features include premium-content');
  assert(body.features.includes('tutorials'), 'features include tutorials');
  assert(body.features.includes('measurements'), 'features include measurements');
  assert(body.features.includes('visual-mode'), 'features include visual-mode');
  assert(body.features.includes('not-this'), 'features include not-this');
  assert(body.features.includes('source-class'), 'features include source-class');
  ...
  assert(body.build === '50-agent-testable-progressive' || body.build === '49.14-person-image-results' || body.build === '49.13-investigation-actions' || body.build === '49.12-investigation-workflow' || body.build === '49.11-exact-source-retrieval' || body.build === '49.9-identity-queue-visual' || body.build === '49.8-adaptive-investigation' || body.build === '49.7-retrieval-engine' || body.build === '49.6-correctness-ux' || body.build === '49.5-adult-first-nl' || body.build === '49.4-deep-dive-lenses' || body.build === '49.3-chatgpt-access', 'build current');
