...
{
  assert(PLANNER_VERSION === '49.6' || PLANNER_VERSION === '49.5' || PLANNER_VERSION === '49.4', 'PLANNER_VERSION current');
  assert(/49\.(4|5|6)/.test(PLANNER_BUILD), 'PLANNER_BUILD');
  assert(/const VERSION = '49\.[456]'/.test(appSrc), 'frontend VERSION');
  assert(/carmen-build" content="49\.[456]"/.test(html), 'html build');
