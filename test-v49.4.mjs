...
{
  assert(PLANNER_VERSION === '49.9' || PLANNER_VERSION === '49.8' || PLANNER_VERSION === '49.7' || PLANNER_VERSION === '49.6' || PLANNER_VERSION === '49.5' || PLANNER_VERSION === '49.4', 'PLANNER_VERSION current');
  assert(/49\.(4|5|6|7|8|9)/.test(PLANNER_BUILD), 'PLANNER_BUILD');
  assert(/const VERSION = '49\.[456789]'/.test(appSrc), 'frontend VERSION');
  assert(/carmen-build" content="49\.[456789]"/.test(html), 'html build');
